...
<body id="header">
	<div class="header_new">
		<div class="topnav">
			<div class="icon">
				<a href="/TeamProject/Home/main.jsp"><img src="/TeamProject/Images/logo.png" /></a>
			</div>
			...
			<div class="category">
				...
				<%}%>
				<a href="/TeamProject/Tutor/Register/menu.jsp">튜터등록</a><!-- 등록페이지로 이동하게 수정 -->
				...
				<%
					...
					<%}else{%>
						...
						<a href="/TeamProject/My/application.jsp"><img src="/TeamProject/Images/Icon/user.png" width="35px"/></a> 
					<%}%>
			</div>
